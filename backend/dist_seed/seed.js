...
async function main() {
    ...
    const accounts = [
        ...
        { code: '20', name: 'Immobilisations en non-valeurs', classCode: '2', type: 'ASSET' },
        { code: '21', name: 'Immobilisations incorporelles', classCode: '2', type: 'ASSET' },
        { code: '22', name: 'Terrains', classCode: '2', type: 'ASSET' },
        { code: '23', name: 'Constructions', classCode: '2', type: 'ASSET' },
        { code: '232', name: 'Bâtiments agricoles', classCode: '2', type: 'ASSET' },
        { code: '24', name: 'Installations techniques', classCode: '2', type: 'ASSET' },
        { code: '241', name: 'Systèmes d\'irrigation', classCode: '2', type: 'ASSET' },
        { code: '242', name: 'Serres et abris', classCode: '2', type: 'ASSET' },
        { code: '25', name: 'Matériel et outillage', classCode: '2', type: 'ASSET' },
        { code: '251', name: 'Matériel agricole', classCode: '2', type: 'ASSET' },
        { code: '2511', name: 'Tracteurs', classCode: '2', type: 'ASSET' },
        { code: '2512', name: 'Moissonneuses-batteuses', classCode: '2', type: 'ASSET' },
        { code: '2513', name: 'Outils et équipements', classCode: '2', type: 'ASSET' },
        { code: '26', name: 'Matériel de transport', classCode: '2', type: 'ASSET' },
        { code: '261', name: 'Véhicules agricoles', classCode: '2', type: 'ASSET' },
        { code: '27', name: 'Cheptel (immobilisé)', classCode: '2', type: 'ASSET' },
        { code: '271', name: 'Animaux reproducteurs', classCode: '2', type: 'ASSET' },
        { code: '28', name: 'Amortissements des immobilisations', classCode: '2', type: 'ASSET' },
        // CLASSE 3 - STOCKS
        { code: '31', name: 'Stocks de semences', classCode: '3', type: 'STOCK' },
        { code: '32', name: 'Stocks de produits phytosanitaires', classCode: '3', type: 'STOCK' },
        { code: '33', name: 'Stocks d\'engrais', classCode: '3', type: 'STOCK' },
        { code: '35', name: 'Stocks de récoltes', classCode: '3', type: 'STOCK' },
        { code: '351', name: 'Stocks de céréales', classCode: '3', type: 'STOCK' },
        { code: '352', name: 'Stocks de légumes', classCode: '3', type: 'STOCK' },
        { code: '353', name: 'Stocks de fruits', classCode: '3', type: 'STOCK' },
        { code: '36', name: 'Stocks animaux (engraissement)', classCode: '3', type: 'STOCK' },
        { code: '37', name: 'Stocks d\'aliments bétail', classCode: '3', type: 'STOCK' },
        { code: '38', name: 'Autres stocks et approvisionnements', classCode: '3', type: 'STOCK' },
        // CLASSE 6 - CHARGES
        { code: '61', name: 'Charges d\'exploitation agricole', classCode: '6', type: 'EXPENSE' },
        { code: '611', name: 'Achats de semences et plants', classCode: '6', type: 'EXPENSE' },
        { code: '612', name: 'Achats d\'engrais et amendements', classCode: '6', type: 'EXPENSE' },
        { code: '613', name: 'Achats de produits phytosanitaires', classCode: '6', type: 'EXPENSE' },
        { code: '614', name: 'Achats d\'aliments pour animaux', classCode: '6', type: 'EXPENSE' },
        { code: '62', name: 'Frais d\'irrigation', classCode: '6', type: 'EXPENSE' },
        { code: '621', name: 'Eau d\'irrigation', classCode: '6', type: 'EXPENSE' },
        { code: '622', name: 'Énergie (pompage)', classCode: '6', type: 'EXPENSE' },
        { code: '63', name: 'Frais de main-d\'œuvre', classCode: '6', type: 'EXPENSE' },
        { code: '631', name: 'Salaires permanents', classCode: '6', type: 'EXPENSE' },
        { code: '632', name: 'Main-d\'œuvre saisonnière', classCode: '6', type: 'EXPENSE' },
        { code: '633', name: 'Charges sociales', classCode: '6', type: 'EXPENSE' },
        { code: '64', name: 'Frais vétérinaires et sanitaires', classCode: '6', type: 'EXPENSE' },
        { code: '641', name: 'Frais vétérinaires', classCode: '6', type: 'EXPENSE' },
        { code: '642', name: 'Médicaments et vaccins', classCode: '6', type: 'EXPENSE' },
        { code: '65', name: 'Autres charges d\'exploitation', classCode: '6', type: 'EXPENSE' },
        { code: '651', name: 'Carburant et lubrifiants', classCode: '6', type: 'EXPENSE' },
        { code: '652', name: 'Entretien du matériel', classCode: '6', type: 'EXPENSE' },
        { code: '653', name: 'Frais de transport et vente', classCode: '6', type: 'EXPENSE' },
        { code: '654', name: 'Assurances agricoles', classCode: '6', type: 'EXPENSE' },
        { code: '655', name: 'Locations (terres, matériel)', classCode: '6', type: 'EXPENSE' },
        { code: '68', name: 'Dotations aux amortissements', classCode: '6', type: 'EXPENSE' },
        { code: '681', name: 'Amortissement du matériel agricole', classCode: '6', type: 'EXPENSE' },
        { code: '682', name: 'Amortissement des constructions', classCode: '6', type: 'EXPENSE' },
        // CLASSE 7 - PRODUITS
        { code: '71', name: 'Ventes de productions végétales', classCode: '7', type: 'REVENUE' },
        { code: '711', name: 'Ventes de céréales', classCode: '7', type: 'REVENUE' },
        { code: '712', name: 'Ventes de légumes', classCode: '7', type: 'REVENUE' },
        { code: '713', name: 'Ventes de fruits', classCode: '7', type: 'REVENUE' },
        { code: '714', name: 'Ventes de cultures industrielles', classCode: '7', type: 'REVENUE' },
        { code: '72', name: 'Ventes de productions animales', classCode: '7', type: 'REVENUE' },
        { code: '721', name: 'Ventes d\'animaux sur pied', classCode: '7', type: 'REVENUE' },
        { code: '722', name: 'Ventes de lait', classCode: '7', type: 'REVENUE' },
        { code: '723', name: 'Ventes d\'œufs et aviculture', classCode: '7', type: 'REVENUE' },
        { code: '724', name: 'Ventes de laine et autres sous-produits', classCode: '7', type: 'REVENUE' },
        { code: '75', name: 'Autres produits d\'exploitation', classCode: '7', type: 'REVENUE' },
        { code: '751', name: 'Subventions agricoles', classCode: '7', type: 'REVENUE' },
        { code: '752', name: 'Indemnités d\'assurance', classCode: '7', type: 'REVENUE' },
        { code: '753', name: 'Produits divers', classCode: '7', type: 'REVENUE' },
    ];
    ...
    if (accSemences && accEngrais && accPhyto && accMOeuvre && accCarburant &&
        ...
        // CHARGES
        {
            ...
            type: 'EXPENSE', amount: 12500, description: 'Semences blé Arrehane certifiées - 500 kg',
            paymentMethod: 'BANK_TRANSFER', createdByUserId: admin.id,
            quantity: 500, unit: 'kg',
        }, {
            projectId: project.id, accountId: accEngrais.id, date: new Date('2024-02-05'),
            type: 'EXPENSE', amount: 28000, description: 'NPK 15-15-15 et Urée 46% - 4 tonnes',
            paymentMethod: 'CASH', createdByUserId: associate1.id,
            quantity: 4000, unit: 'kg',
        }, {
            projectId: project.id, accountId: accPhyto.id, date: new Date('2024-03-10'),
            type: 'EXPENSE', amount: 8500, description: 'Herbicides et fongicides saison blé',
            paymentMethod: 'CASH', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accIrrigation.id, date: new Date('2024-02-15'),
            type: 'EXPENSE', amount: 4200, description: 'Eau irrigation serre - facture ONEE février',
            paymentMethod: 'BANK_TRANSFER', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accIrrigation.id, date: new Date('2024-03-15'),
            type: 'EXPENSE', amount: 5100, description: 'Eau irrigation serre - facture ONEE mars',
            paymentMethod: 'BANK_TRANSFER', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accMOeuvre.id, date: new Date('2024-04-01'),
            type: 'EXPENSE', amount: 18000, description: 'Main-d\'œuvre saisonnière - labour et plantation',
            paymentMethod: 'CASH', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accMOeuvre.id, date: new Date('2024-06-20'),
            type: 'EXPENSE', amount: 22000, description: 'Main-d\'œuvre moisson blé - 30 ouvriers x 7 jours',
            paymentMethod: 'CASH', createdByUserId: associate1.id,
        }, {
            projectId: project.id, accountId: accCarburant.id, date: new Date('2024-03-31'),
            type: 'EXPENSE', amount: 9800, description: 'Carburant tracteur et véhicule Q1 2024',
            paymentMethod: 'CASH', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accCarburant.id, date: new Date('2024-06-30'),
            type: 'EXPENSE', amount: 11200, description: 'Carburant tracteur et véhicule Q2 2024',
            paymentMethod: 'CASH', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accAliments.id, date: new Date('2024-02-01'),
            type: 'EXPENSE', amount: 23500, description: 'Aliments bétail - ovins et bovins',
            paymentMethod: 'CASH', createdByUserId: associate1.id,
        }, {
            projectId: project.id, accountId: accAliments.id, date: new Date('2024-05-01'),
            type: 'EXPENSE', amount: 27000, description: 'Aliments bétail Q2 - concentré finition',
            paymentMethod: 'CASH', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accVeterin.id, date: new Date('2024-03-15'),
            type: 'EXPENSE', amount: 6000, description: 'Frais vétérinaires - vaccination annuelle cheptel',
            paymentMethod: 'CASH', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accEntretien.id, date: new Date('2024-04-20'),
            type: 'EXPENSE', amount: 7500, description: 'Révision tracteur + remplacement pneus',
            paymentMethod: 'BANK_TRANSFER', createdByUserId: admin.id,
        }, {
            projectId: project.id, accountId: accTransport.id, date: new Date('2024-07-05'),
            type: 'EXPENSE', amount: 4800, description: 'Transport récolte blé vers moulin',
            paymentMethod: 'CASH', createdByUserId: associate1.id,
        }, 
        // PRODUITS / REVENUS
        {
            projectId: project.id, accountId: accVenteCereales.id, date: new Date('2024-07-10'),
            type: 'SALE', amount: 25200, description: 'Vente blé Arrehane Q1 - 7000 kg x 3.60 DH/kg',
            paymentMethod: 'BANK_TRANSFER', createdByUserId: admin.id,
            quantity: 7000, unit: 'kg',
        }, {
            projectId: project.id, accountId: accVenteLegumes.id, date: new Date('2024-05-20'),
            type: 'SALE', amount: 18250, description: 'Vente tomates souk local - 7300 kg x 2.50 DH/kg',
            paymentMethod: 'CASH', createdByUserId: associate1.id,
            quantity: 7300, unit: 'kg',
        }, {
            projectId: project.id, accountId: accVenteLegumes.id, date: new Date('2024-07-02'),
            type: 'SALE', amount: 37200, description: 'Vente tomates grossiste Casa - 6200 kg x 6.00 DH/kg',
            paymentMethod: 'BANK_TRANSFER', createdByUserId: admin.id,
            quantity: 6200, unit: 'kg',
        }, {
            projectId: project.id, accountId: accVenteAnimaux.id, date: new Date('2024-07-01'),
            type: 'SALE', amount: 11000, description: 'Vente 5 brebis D\'man - 5 x 2200 DH',
            paymentMethod: 'CASH', createdByUserId: associate1.id,
            quantity: 5, unit: 'têtes',
        }, {
            projectId: project.id, accountId: accVenteAnimaux.id, date: new Date('2024-07-15'),
            type: 'SALE', amount: 30000, description: 'Vente 2 bovins engraissés - 2 x 15000 DH',
            paymentMethod: 'CASH', createdByUserId: admin.id,
            quantity: 2, unit: 'têtes',
        }, {
            projectId: project.id, accountId: accSubvention.id, date: new Date('2024-04-30'),
            type: 'SALE', amount: 15000, description: 'Subvention Plan Maroc Vert - prime à la productivité',
            paymentMethod: 'BANK_TRANSFER', createdByUserId: admin.id,
        });
